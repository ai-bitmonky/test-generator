#!/usr/bin/env node
/**
 * Parse and insert problematic Physics questions from corrected HTML file
...
async function main() {
  console.log('🚀 Starting insertion from problematic Physics HTML file...\n');

  const filename = 'problematic_physics_questions.html';
  ...
  // Save report
  const reportFile = 'problematic_physics_insertion_report.json';
